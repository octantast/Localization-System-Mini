...
Проста система локалізації тексту на основі CSV для проєктів Unity з використанням TextMeshPro. Автоматична зміна шрифтів, динамічні плейсхолдери, оптимізація з кешуванням.
